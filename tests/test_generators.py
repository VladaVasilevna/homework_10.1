...
def test_filter_by_currency_no_currency_operations() -> None:
    ...
    transactions_no_currency = [
        ...
        {"id": 5, "operationAmount": {"amount": "500", "currency": {"code": None}}},  # Код валюты None
    ]
...
def test_card_number_generator_edge_cases() -> None:
    ...
    assert result == ["0000 0000 0000 9999", "0000 0000 0001 0000", "0000 0000 0001 0001", "0000 0000 0001 0002"]
